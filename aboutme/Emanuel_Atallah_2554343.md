...
* Take care of and clean the all-you-can-eat salad bar.
* Make every salad and soup on that salad bar.
* Prep the salads for the next day (cut vegetables, cook pasta, etc) 

### Skills
|**Technical**|**Communications**|
|---|---|
|Programming (C#)|Speak multiple languages (French,english,arabic)|
|WordPress|Work well in teams|

### Education
|**Degree**|**School**|**Year**|
|---|---|---|
|High school diploma|École Secondaire Félix-Leclerc|2025|